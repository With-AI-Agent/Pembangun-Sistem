...
- **Di mana kita sekarang:** **draft Tahap 4 sudah dibuat** dan STATUS menjadi `ready-for-review`; belum ada penguncian atau asset. Entry point + keputusan recovery + penutupan retrospektif log PR #12 tersimpan di checkpoint `34d550ae02705c33493c017c628cf6afd6a3463f`. Detail output dan approval: STATUS unit produksi; naskah sumber tetap tidak berubah.
...
- **Langkah berikutnya:** commit+push checkpoint draft dan buka PR draft untuk review. Minta keputusan pengguna pada **G2 naskah final**, terutama penanganan durasi; rekomendasi revisi draft lebih dulu, bukan mengubah brief sendiri. G1/G2 breakdown baru ditanyakan setelah dependency naskah diselesaikan. Jika sesi terputus, lanjutkan dari log ini + STATUS di branch/PR yang sama; jangan mengulang pekerjaan atau menganggap review sudah diberikan.
