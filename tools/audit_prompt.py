...
def render(objek: str, sha: str, kedalaman: str, generic: bool) -> str:
    ...
    if generic:
        ...
        sha_ref = sha
    a("Hasil audit dikirim ke **GitHub Issue** — bukan PR, karena ini memang bukan review PR. Judul dan label")
    a("**berpola tetap** supaya sesi yang sedang berjalan bisa **menemukannya sendiri** tanpa diberi tahu:")
    a("")
    a("```bash")
    ...
    a("")
    a("**Append-only:** kalau ada putaran kedua, **tambahkan** sebagai komentar Issue. Jangan menghapus atau")
    a("menyunting temuan putaran pertama, dan **jangan menghaluskan**.")
    a("")
    a("Sesi yang diaudit kemudian mengambil hasilnya sendiri dengan:")
    a("")
    a("```bash")
