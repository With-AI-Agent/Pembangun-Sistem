...
def render(pr: dict | None, files: list[str], generic: bool,
    ...
    a("gagal — ini **sudah terjadi** pada PR ini: dua dari tiga verdict tidak pernah sampai, sehingga PR")
    a("terbaca berkuorum 1/3 padahal tiga hakim sudah bekerja.")
    a("")
    ...
    a("")
    a("Untuk putusan hijau, ganti kata `MERAH` dengan `HIJAU` di baris itu (dan sebut putarannya). Lalu di")
