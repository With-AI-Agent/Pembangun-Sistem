...
def write_seed_system() -> None:
    ...
    (root / "SYSTEM_MANIFEST.md").write_text(
        ...
        "| W-10 audit isi + pengiriman hasil | diterapkan | audit via tools/audit_prompt.py --objek <folder sistem ini>; ambil hasil via tools/ambil_verdict.py --terbaru; ATURAN CAKUPAN disalin ke dokumen QA sistem | |\n\n"
        "## Log Keputusan\n\n"
