...
| 5 Sep 2026 | 0.3.2-warisan-sync | Sinkronisasi kontrak warisan meta v1.3.0: tabel Warisan ditambahkan; wording provenance ("Audit acuan", rujukan recovery di `00_CARA_PAKAI_SISTEM.md` baris Lanjutan terputus → aturan inline menang, `_meta` opsional); fix M-19 (baris L-05 basi menyebut AT-KK-05b "belum diuji" padahal LULUS 5 Sep); ringkasan cadangan disinkronkan | Permintaan pengguna: butir wajib harus tertanam & TERUKUR untuk semua sistem; perubahan wording/pencatatan saja — dokumen aturan `00`/`05`/`06` tidak berubah, jadi klausul regresi acceptance test TIDAK terpicu |
