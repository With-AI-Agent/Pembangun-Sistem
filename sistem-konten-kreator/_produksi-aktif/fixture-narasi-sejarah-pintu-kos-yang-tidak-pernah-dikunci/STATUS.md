...
- **Output resmi:**
  ...
  - `assets/` — **ADA**, 9 file `.jpg` (S1, S2, S2a, S3, S4, S5, S5a, S6, S7) + `CATATAN-ASSET.md`; **diterima G1 Tahap 5 (2026-09-10)**
  - `publish-prep.md` — **ADA**, usulan metadata publish (5 opsi judul, caption, hashtag, konsep thumbnail) + panduan assembly; menunggu G2 Tahap 6
  - **Arsip (permanen, di luar folder produksi):** `channel-fixture-narasi-sejarah/arsip-naskah/2026-09-10-pintu-kos-yang-tidak-pernah-dikunci.md` + `2026-09-10-pintu-kos-yang-tidak-pernah-dikunci-metadata.md`; `indeks.md` diperbarui (3 entri). File `-sumber.md`: tidak ada (tanpa sumber eksternal). `indeks-karakter.md`: tidak berubah (tanpa karakter Tipe B)
