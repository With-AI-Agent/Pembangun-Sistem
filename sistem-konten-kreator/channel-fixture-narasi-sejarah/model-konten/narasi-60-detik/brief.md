...
> **FIXTURE — bukan model konten produksi sungguhan.** Status uji: AT-KK-05 / Run 4 **GAGAL**, `0.3.2-warisan-sync`; AT-KK-05 / Run 5 **GAGAL-metode** (koreksi pasca-review 6 Sep), `0.3.3`; Run 6 lama **void**; AT-KK-05 / Run 7 + AT-KK-05b / Run 8 **dijadwalkan**, `0.3.4`; F7 TERBUKA. Rujukan: [ACCEPTANCE_TEST_LOG.md](../../../ACCEPTANCE_TEST_LOG.md).
