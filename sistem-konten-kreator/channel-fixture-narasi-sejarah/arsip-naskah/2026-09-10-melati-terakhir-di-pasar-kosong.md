...
- **Judul tayang resmi yang diusulkan:** "Melati Terakhir di Pasar yang Mulai Kosong" (Opsi 1 dari publish-prep.md — menunggu G2 konten final)
...
- **Konsep & Angle:** hook "Dulu, ada satu genggam melati yang selalu habis paling akhir." + 3 varian, struktur 4 beat (0-8 benda pintu masuk, 8-35 konteks kebiasaan, 35-52 yang berubah, 52-60 penutup masa kini), estimasi 132 kata / 63,92 dtk, visual b-roll 7 segmen
...
- **Breakdown:** 7 segmen narasi (S1 17 kata, S2 22, S3 20, S4 10, S5 23, S6 18, S7 23), b-roll netral, prompt generate per segmen (Prompt Library D), file referensi tidak ada (channel faceless — keterangan eksplisit)
