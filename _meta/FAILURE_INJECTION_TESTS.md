...
**Jumlah:** 56 skenario di master (15 sintetis + 7 unit nyata + 14 regresi review PR-11 + 10 regresi check_selfcontained + 10 regresi review_prompt), 16 di ekstrak template (15 sintetis + 1 unit nyata benih; regresi repo-copy tidak dijalankan bersarang). Angka ini disalin dari baris yang dicetak `tools/test_failure_injection.py`, bukan dihitung tangan.
