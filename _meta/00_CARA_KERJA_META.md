...
- **Checklist penutupan sesi:** PR dibuka → `tools/review_prompt.py --pr <N>` dijalankan dan keluarannya ditempel di chat (aturan lengkap: `PROTOKOL_REVIEW_INDEPENDEN.md` §"Sumber prompt")
