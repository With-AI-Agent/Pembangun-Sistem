...
4. **Diverifikasi otomatis.** `tools/validate_repo.py` mengecek butir yang dapat dicek mekanis (berkas pegangan, manifest, turunan LOG_SESI, field checkpoint unit kerja) untuk SETIAP sistem terdaftar di `INDEKS_SISTEM.md`. Sistem baru otomatis tercakup begitu didaftarkan — tidak ada lagi "validator lupa didaftarkan" (gaya kegagalan temuan M-01/M-03 audit 5 Sep 2026).
