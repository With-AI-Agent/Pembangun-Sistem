...
- **Meta-sistem (`_meta/`)** — ini kerangka yang menaungi semua sistem, bukan salah satu isinya. Statusnya dilacak di `_meta/SYSTEM_MANIFEST.md` (saat ini `Released — v1.12.0`, terakhir disentuh 9 September 2026: pegangan pengguna wajib + log sesi berkelanjutan + kontrak warisan W-01…W-09 + tools regresi berbasis INDEKS + protokol review independen + folder sistem sebagai deliverable + cakupan gerbang mandiri diselaraskan dengan definisi dokumen aktif + dua sistem domain lama dituntaskan menjadi folder mandiri).
