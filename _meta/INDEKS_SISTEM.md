...
|---|---|---|---|---|
| Sistem Presentasi | `sistem-presentasi/` | Selesai, belum diaudit — deck nyata pertama lolos G1–G3 & terbangun | 5 September 2026 | Unit aktif `deck-aktif/presentasi-tesis-fikih-hiasan-wanita/` selesai (G3 disetujui 5 Sep 2026); keluaran `.pptx` RTL 13 slide + `preview.html`. Bahan Arab dibaca via **visi** (ekstraksi teks teracak). Field pembimbing dikosongkan (tidak ada di bahan). Belum audit menyeluruh. |
