...
|---|---|---|---|---|
| T-19 | **A-01: 3 artefak mekanisme audit-isi tidak terdaftar di inventaris inti statis** — menghapusnya tidak membuat alat mana pun gagal | P2 | TERBUKA | fix ada di working tree; **sha menyusul di baris ini pada commit berikutnya** (aturan: `SELESAI` wajib sha) |
| T-20 | **A-02: `_meta/PROTOKOL_REVIEW_INDEPENDEN.md` tidak terdaftar di inventaris inti statis** (pre-existing) | P3 | TERBUKA | fix ada di working tree; **sha menyusul di baris ini pada commit berikutnya** |
