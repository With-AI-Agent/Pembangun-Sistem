...
|---|---|---|---|
| T1 | Sistem untuk **kebutuhan apa pun** (wedding, khitanan, webinar, dst) | TERJADWAL | riset baseline pasar: DISKUSI_MENTAH bagian A (7 situs pembanding). Eksekusi: item **T-18**  **Sudah dituangkan ke: Rencana Kerangka draft bagian 1 (cakupan acara = data di L2, bukan asumsi di kode)** (item T-27 menunggu review pemilik)|
| T2 | Output **multi-format**: web, video, flyer, siap cetak, lainnya | TERJADWAL | spesifikasi per format sudah diriset: bagian **C** (cetak: CMYK/300 DPI/bleed 3 mm/PDF-X) + bagian **D** (video: jebakan lisensi Remotion). Eksekusi: item **T-18**  **Sudah dituangkan ke: Rencana Kerangka draft bagian 2.3 tahap 5–6 (satu sumber data → banyak format)** (item T-27 menunggu review pemilik) **Diperbarui 17 Sep sore: Rencana Kerangka 4.3 (gerbang aset 3 hasil)**|
...
| T6 | Sesi **desain + format** sampai **publish / serah terima** | TERJADWAL | bentuk SIKLUS 7 tahap + BERTINGKAT 3 lapis sudah dirumuskan (bagian A/H). Eksekusi: item **T-18**  **Sudah dituangkan ke: Rencana Kerangka draft bagian 2.3 (SIKLUS 7 tahap) + 4.1 (6 gerbang)** (item T-27 menunggu review pemilik)|
