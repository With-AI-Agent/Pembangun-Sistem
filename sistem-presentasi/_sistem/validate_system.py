...
REQ_ROOT=["START_DI_SINI.md","SYSTEM_MANIFEST.md","00_RENCANA_KERANGKA.md","ACCEPTANCE_TESTS.md"]
REQ_SISTEM=[f"{i:02d}" for i in range(1,11)]
...
REQ_DECK=["BRIEF.md","PEMAHAMAN_BAHAN.md","CHECKLIST_CAKUPAN.md","OUTLINE.md","RENCANA_VISUAL.md","STATUS.md"]
