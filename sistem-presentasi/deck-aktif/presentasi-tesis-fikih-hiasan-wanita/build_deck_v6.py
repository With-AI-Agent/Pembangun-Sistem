...
para(s,"يبين البحث أحكام النوازل الفقهية المعاصرة المتعلقة بزينة المرأة - من التشقير إلى الوصل والعمليات - في المذاهب الأربعة، بمنهج وصفي مقارن استقرائي استنباطي؛ فالأصل التحريم عند تغيير خلق الله أو التدليس أو الضرر، والجواز بضوابطها، وللزينة أثر في عقد النكاح.")
notes(s,"ملخص hal 6, satu slide sesuai permintaan pemilik.")
...
notes(s,"معالجة hal 89 (Far'3).")

# S12 تحقق
s=new_slide(12,"ص٨٩"); title(s,"التحقق من صحة المعلومات")
bullets(s,[
 "عرض المعلومة على عدة مصادر مختلفة",
 "اعتمادها عند اتفاق المعنى وإن اختلفت الألفاظ",
])
notes(s,"تحقق hal 89 (Far'4).")
