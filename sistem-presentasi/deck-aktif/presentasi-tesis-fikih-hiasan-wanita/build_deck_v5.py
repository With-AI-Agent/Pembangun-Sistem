...
para(s,"توزن وسائل الزينة المعاصرة بثلاث علل: تغيير خلق الله، والتدليس، والضرر؛ فمتى تحققت إحداها امتنع الفعل، ومتى انتفت جاز. ومن هنا يفهم حكم النمص والوشم والتشقير والوصل والعدسات، والمنهج وصفي مقارن استقرائي استنباطي.")
...
bullets(s,[
 ...
 "العدسات والأظافر: توزن بضوابط التغيير والتدليس والضرر",
...
# S5
s=new_slide(5,"ص٦"); title(s,"للزينة أثر في النظر داخل عقد النكاح، وترتب أحكامها وفق المذاهب")
bullets(s,[
 "الزينة المؤثرة على النظر ترتب أحكامها في باب النكاح",
...
para(s,"خلاصة البحث أن التحريم يدور مع علله الثلاث وجودا وعدما، وأن العمليات تجوز للحاجة والوصل يجوز بغير شعر الآدمي بضوابطهما، وأن للزينة أثرا يرتب على النظر في عقد النكاح وفق المذاهب.")
...
# S14
s=new_slide(14,"ص١٥١"); title(s,"الحمد لله؛ جهد بشري يقبل الخطأ، وسئل الله القبول والنفع")
bullets(s,[
