# CHECKLIST CAKUPAN — Presentasi Tesis Fikih Hiasan Wanita

> Semua baris kini `sudah dipetakan` lewat jalur visi. Beberapa catatan halaman: pemilik memberi nomor yang bergeser satu untuk tujuan (nyata hal 21) dan خاتمة/توصيات (nyata 151/152). Itu dicatat di `PEMAHAMAN_BAHAN.md`, bukan disembunyikan.

| # | Bagian | Hal pemilik | Hal nyata | Status | Bukti |
|---|---|---|---|---|---|
| 1 | Ringkasan | 6 | 6 | sudah | kartu 1 |
| 2 | Tujuan | 20 | 21 | sudah | kartu 2 |
| 3 | Manfaat | 21 | 21 | sudah | kartu 3 |
...
| 11 | Verifikasi | 89 | 89 | sudah | kartu 11 |
| 12 | Penutup | 152 | 151 | sudah | kartu 12 |
| 13 | Rekomendasi | 153 | 152 | sudah | kartu 13 |
...
- Kontras: ekstraksi teks pada halaman sama mengacak urutan kata → tidak dipakai untuk kartu.
