# -*- coding: utf-8 -*-
"""v4 — memperbaiki bug visual deck#1/#3 sesuai _sistem/02:
 (B) aspect-ratio: pita gambar di-CROP ber-aspek sama (tidak gepeng);
 (C) bidi: hapus kurung ASCII/em-dash/+ di teks Arab;
 (D) mode PARAGRAF dipakai di slide naratif (S2, S12) + bullet di slide daftar.
"""
...
para(s,"تُوزن وسائل الزينة المعاصرة بثلاث علل: تغيير خلق الله، والتدليس، والضرر؛ فمتى تحققت إحداها امتنع الفعل، ومتى انتفت جاز. ومن هنا يُفهم حكم النمص والوشم والتشقير والوصل والعدسات، ويبقى المنهج وصفيًا مقارنًا استقرائيًا استنباطيًا.")
notes(s,"Temuan utama hal 6 disajikan sebagai PARAGRAF ringkas (mode naratif).")
...
bullets(s,[
 ...
 "العدسات والأظافر: تُوزن بضوابط التغيير والتدليس والضرر",
 "الوصل: محرم، ويجوز بغير شعر الآدمي اتفاقًا",
])
notes(s,"Hal 6: rincian per jenis.")
...
bullets(s,[
 "جمع: تتبّع أقوال المذاهب وجمع النوازل ثم الترتيب والمقارنة",
...
table_slide(s,[
 ...
 ("المالكية","مركّبة: تغيير خلق الله والتدليس"),
 ("الشافعية","مركّبة: الكرامة وتحريم استعمال النجس"),
...
para(s,"خلاصة البحث أن التحريم يدور مع علله الثلاث وجودًا وعدمًا، وأن العمليات تجوز للحاجة والوصل يجوز بغير شعر الآدمي بضوابطهما، وأن للزينة أثرًا يُرتَّب على النظر في عقد النكاح وفق المذاهب.")
notes(s,"Kesimpulan sebagai PARAGRAF; خاتمة hal 151 = doa.")
...
prs.save(OUT)
print("saved v4 slides:", len(prs.slides._sldIdLst), "crop band f=%.3f"%((0.9/H)*_IH/_IW))
