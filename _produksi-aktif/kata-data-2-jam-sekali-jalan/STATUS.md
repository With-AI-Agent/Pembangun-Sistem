...
- **Sumber eksternal dipakai:** ada — `SUMBER.md` dibuat, klaim belum terverifikasi: tidak ada (angka utama 2 sumber independen; 1 perhitungan sendiri dilabeli eksplisit)
