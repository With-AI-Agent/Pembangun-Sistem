...
- **Versi:** `0.10.0`
- **Tahap:** `draft` — `01_IDENTITAS_PEMILIK.md` terisi (**G0 LULUS** 20 Sep 2026, dinyatakan pemilik) + `02_PROFIL_JENIS_ACARA.md` terisi jenis acara pertama: pernikahan (**G1 LULUS 20 Sep 2026 — putusan pemilik via merge PR #88 `f60e950`, 16:48 UTC**) + `03_TEMPLATE_DATA_ACARA.md` terisi (**roadmap b1 (1/2), template biasa** — penurunan dari field L2 pernikahan; review isi pemilik selesai 20 Sep 2026 (PR #90) + **PR #90 MERGED `de9bd12` (20 Sep 2026 23:59:25 UTC) → b1 LULUS**) + `04_TEMPLATE_BRIEF_UNDANGAN.md` terisi (**roadmap b1 (2/2), template biasa** — brief Tahap 1–2; review isi pemilik selesai 20 Sep 2026 (PR #90) + **PR #90 MERGED `de9bd12` → b1 LULUS**) + `05_DISCOVERY_DESAIN_PROMPT.md` terisi (**roadmap b2, Discovery 05, dokumen generator** — prompt client-facing Tahap 3 + batas janji; keputusan pemilik atas paket **B1–B6** 21 Sep 2026) + `06_SPESIFIKASI_ASET_DAN_RESOLUSI.md` terisi (**roadmap b2, Discovery 06, dokumen generator** — dua tingkat aset + gerbang **G3** fail-closed; angka dikutip dari 00 §4.3–4.5; keputusan pemilik atas paket **C1–C6** 21 Sep 2026) + `11_AMPLOP_DIGITAL.md` terisi (**roadmap b2, Discovery 11, template biasa** — amplop digital: rekening + QRIS statis tanpa payment gateway, etika per acara, titik verifikasi rekening G2/G5, batas janji; tanpa keputusan baru pemilik) + `09_PANDUAN_PUBLISH_DAN_SERAH_TERIMA.md` terisi (**roadmap b2, gerbang G5 — kategori BESAR**, panduan publish & serah terima untuk orang tanpa basic coding: **keputusan pemilik paket D1–D6** — hosting fase 1 di akun studio · skema path permanen · naik fase tanpa mematikan tautan · belum ada CMS di fase 1 · masa aktif & nasib data · biaya/plafon + jalur darurat; bagian yang butuh dokumen 10 **dinyatakan terbuka** per putusan B6); ubah ke `siap-pakai` saat sistem siap dipakai (cek W-01/W-02/W-03 kembali ketat; lihat `03_KONTRAK_WARISAN.md` bagian "Tahap pembangunan")
- **Status:** `Draft`
- **Tanggal dibuat:** 2026-09-17
- **Audit terakhir:** belum ada — **G0 LULUS 20 Sep 2026** (review isi lengkap oleh pemilik + PR #86 merged, `36c63d4`); **G1 (isi L2 pernikahan) LULUS 20 Sep 2026 — putusan pemilik via merge PR #88 (`f60e950`, 16:48 UTC)**; sifat putusan direkam jujur di log sesi slot 43 (dasar = approval butir-per-butir di chat, tanpa review dalam tersendiri; audit independen pasca-merge tersedia atas permintaan pemilik); benturan klasifikasi G1 (prompt 02 BESAR vs manifest Kecil vs rencana kerangka bagian 4 gerbang produksi-Sedang) **diputus pemilik: dibiarkan pada keadaan tercatat** — tidak memblokir, bisa dibuka lewat Log Keputusan dokumen 02; **roadmap b1 tuntas sampai draft 20 Sep 2026 (UTC): `03_TEMPLATE_DATA_ACARA.md` + `04_TEMPLATE_BRIEF_UNDANGAN.md` terisi (template biasa, tanpa keputusan baru pemilik; draft menunggu review isi PR)** — benturan label G2 (manifest vs 00 bagian 4) dilaporkan di Log Keputusan dokumen 04, tidak diputus sepihak; audit independen isi L1: terbuka atas permintaan pemilik; kelulusan pegangan W-01 menunggu jalur audit-nya sendiri (Syarat 4); **review isi PR b1 (03+04) dijalankan PEMILIK 20 Sep 2026 (sesi slot 44, log sesi): "setuju semua rekomendasi" — benturan label G2 DISelaraskan (baris Titik approval Besar di atas mengikuti 00 bagian 4) + baris Acceptance pegangan dikoreksi (fakta basi, koreksi 20 Sep 2026); draft menunggu merge PR #90 (tanpa auto-merge)**; **b1 LULUS 21 Sep 2026 — PR #90 MERGED `de9bd12` (20 Sep 2026 23:59:25 UTC); sync pasca-merge dijalankan sesi slot 45 (register T-18, STATUS.md, INDEKS, log sesi slot 45) — Versi TIDAK di-bump (tetap 0.6.0; preseden G1 LULUS dokumen 02 yang tidak menaikkan versi 0.4.0)**; **b3 — uji coba 1 undangan pernikahan `rina-dimas-1226` dijalankan sampai pratinjau terbit 21 Sep 2026 (putusan pemilik E1–E4): unit bukan client · model Modern minimalis · web + flyer SVG + QR SVG · **0 aset raster sehingga GERBANG RESOLUSI G3 BELUM TERUJI (dinyatakan terbuka)** · alat baru `validate_unit.py` (gerbang data `03` bagian 7 + bukti aset `06` bagian 8) **rc=0, diuji mutasi 3/3** · uji render DOM nyata **30/30** · daftar periksa Terbit **4 LULUS / 4 sebagian / 1 N/A / 1 menunggu pemilik** · sisa: pemeriksaan pemilik di HP + deploy Cloudflare; bukti `_produksi-aktif/rina-dimas-1226/uji-b3.md`**; **Discovery 05 tuntas 21 Sep 2026 (roadmap b2) — `05_DISCOVERY_DESAIN_PROMPT.md` terisi, v0.6.0→v0.7.0; keputusan pemilik atas paket B1–B6 ("Setuju semua (B1–B6)", log sesi slot 45): bentuk dokumen (+tabel batas janji) · menu arah desain 3 default + 2 sesuai permintaan · batas format fase portofolio (web+flyer; video/cetak belum) · lead time 3 hari kerja + revisi tak terbatas + wajib diukur di produksi nyata pertama · moderasi & data ucapan/RSVP · penyelesaian konflik urutan dokumen 09 vs 10 (09 mengutip 00 + bagian terbuka, 10 tetap ditunda); review isi = PR normal tanpa auto-merge**
...
- **Dokumen instruksi aktif:** `01_IDENTITAS_PEMILIK.md` (**isi — G0 LULUS**, 20 Sep 2026); `02_PROFIL_JENIS_ACARA.md` (**isi — G1 LULUS**, jenis acara pertama: pernikahan, 20 Sep 2026); `03_TEMPLATE_DATA_ACARA.md` (**isi — b1 LULUS**, template biasa, 20 Sep 2026 (UTC); PR #90 MERGED `de9bd12`); `04_TEMPLATE_BRIEF_UNDANGAN.md` (**isi — b1 LULUS**, template biasa, 20 Sep 2026 (UTC); PR #90 MERGED `de9bd12`); `05_DISCOVERY_DESAIN_PROMPT.md` (**isi — draft roadmap b2 (Discovery 05)**, dokumen generator: prompt client-facing Tahap 3 + batas janji, 21 Sep 2026 (UTC)); `06_SPESIFIKASI_ASET_DAN_RESOLUSI.md` (**isi — draft roadmap b2 (Discovery 06)**, dokumen generator: dua tingkat aset + gerbang G3, angka bersumber, 21 Sep 2026 (UTC)); `11_AMPLOP_DIGITAL.md` (**isi — draft roadmap b2 (Discovery 11)**, template biasa: amplop digital rekening + QRIS statis, 21 Sep 2026 (UTC)); `09_PANDUAN_PUBLISH_DAN_SERAH_TERIMA.md` (**isi — draft roadmap b2 (prompt Discovery 09), gerbang G5/BESAR**, panduan publish & serah terima + keputusan pemilik D1–D6, 21 Sep 2026 (UTC)); 3 dokumen domain lainnya masih kerangka
...
- [ ] Semua dokumen wajib tersedia — **belum: 3 dokumen masih kerangka + 8 terisi (01 — G0 LULUS; 02 — G1 LULUS, jenis acara pernikahan; 03 + 04 — **b1 LULUS**, PR #90 MERGED `de9bd12`; 05 — draft roadmap b2 (Discovery 05), keputusan pemilik paket B1–B6, menunggu review isi PR; 06 — draft roadmap b2 (Discovery 06), keputusan pemilik paket C1–C6, menunggu review isi PR; 11 — draft roadmap b2 (Discovery 11), template biasa tanpa keputusan baru pemilik, menunggu review isi PR; 09 — draft roadmap b2 (prompt Discovery 09), gerbang **G5/BESAR**, keputusan pemilik D1–D6, menunggu review isi lengkap PR)**
- [ ] Semua dependency valid — **sebagian, dan sekarang lebih terukur**: dependency **lokal** sudah diuji di uji coba b3 (`rina-dimas-1226`: pratinjau nyata, 11 berkas HTTP 200, render dari satu rekaman data, flyer+QR dihasilkan dari rekaman) — **dependency penerbitan (Cloudflare) TETAP belum diuji dari lingkungan ini** dan deploy-nya dijalankan pemilik (`_produksi-aktif/rina-dimas-1226/uji-b3.md` bagian 5/7)
