...
- **Dokumen instruksi aktif:** `01_IDENTITAS_PEMILIK.md` (**isi — G0 LULUS**, 20 Sep 2026); `02_PROFIL_JENIS_ACARA.md` (**isi — G1 LULUS**, jenis acara pertama: pernikahan, 20 Sep 2026); `03_TEMPLATE_DATA_ACARA.md` (**isi — b1 LULUS**, template biasa, 20 Sep 2026 (UTC); PR #90 MERGED `de9bd12`); `04_TEMPLATE_BRIEF_UNDANGAN.md` (**isi — b1 LULUS**, template biasa, 20 Sep 2026 (UTC); PR #90 MERGED `de9bd12`); `05_DISCOVERY_DESAIN_PROMPT.md` (**isi — draft roadmap b2 (Discovery 05)**, dokumen generator: prompt client-facing Tahap 3 + batas janji, 21 Sep 2026 (UTC)); `06_SPESIFIKASI_ASET_DAN_RESOLUSI.md` (**isi — draft roadmap b2 (Discovery 06)**, dokumen generator: dua tingkat aset + gerbang G3, angka bersumber, 21 Sep 2026 (UTC)); `11_AMPLOP_DIGITAL.md` (**isi — draft roadmap b2 (Discovery 11)**, template biasa: amplop digital rekening + QRIS statis, 21 Sep 2026 (UTC)); 4 dokumen domain lainnya masih kerangka
...
- [ ] Semua dokumen wajib tersedia — **belum: 4 dokumen masih kerangka + 7 terisi (01 — G0 LULUS; 02 — G1 LULUS, jenis acara pernikahan; 03 + 04 — **b1 LULUS**, PR #90 MERGED `de9bd12`; 05 — draft roadmap b2 (Discovery 05), keputusan pemilik paket B1–B6, menunggu review isi PR; 06 — draft roadmap b2 (Discovery 06), keputusan pemilik paket C1–C6, menunggu review isi PR; 11 — draft roadmap b2 (Discovery 11), template biasa tanpa keputusan baru pemilik, menunggu review isi PR)**
