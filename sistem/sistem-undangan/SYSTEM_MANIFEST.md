...
- **Versi:** `0.6.0`
- **Tahap:** `draft` — `01_IDENTITAS_PEMILIK.md` terisi (**G0 LULUS** 20 Sep 2026, dinyatakan pemilik) + `02_PROFIL_JENIS_ACARA.md` terisi jenis acara pertama: pernikahan (**G1 LULUS 20 Sep 2026 — putusan pemilik via merge PR #88 `f60e950`, 16:48 UTC**) + `03_TEMPLATE_DATA_ACARA.md` terisi (**roadmap b1 (1/2), template biasa** — penurunan dari field L2 pernikahan; draft menunggu review isi PR — tanpa auto-merge) + `04_TEMPLATE_BRIEF_UNDANGAN.md` terisi (**roadmap b1 (2/2), template biasa** — brief Tahap 1–2; draft menunggu review isi PR — tanpa auto-merge); ubah ke `siap-pakai` saat sistem siap dipakai (cek W-01/W-02/W-03 kembali ketat; lihat `03_KONTRAK_WARISAN.md` bagian "Tahap pembangunan")
- **Status:** `Draft`
