...
- **Versi:** `0.7.0`
- **Tahap:** `draft` — `01_IDENTITAS_PEMILIK.md` terisi (**G0 LULUS** 20 Sep 2026, dinyatakan pemilik) + `02_PROFIL_JENIS_ACARA.md` terisi jenis acara pertama: pernikahan (**G1 LULUS 20 Sep 2026 — putusan pemilik via merge PR #88 `f60e950`, 16:48 UTC**) + `03_TEMPLATE_DATA_ACARA.md` terisi (**roadmap b1 (1/2), template biasa** — penurunan dari field L2 pernikahan; review isi pemilik selesai 20 Sep 2026 (PR #90) + **PR #90 MERGED `de9bd12` (20 Sep 2026 23:59:25 UTC) → b1 LULUS**) + `04_TEMPLATE_BRIEF_UNDANGAN.md` terisi (**roadmap b1 (2/2), template biasa** — brief Tahap 1–2; review isi pemilik selesai 20 Sep 2026 (PR #90) + **PR #90 MERGED `de9bd12` → b1 LULUS**) + `05_DISCOVERY_DESAIN_PROMPT.md` terisi (**roadmap b2, Discovery 05, dokumen generator** — prompt client-facing Tahap 3 + batas janji; keputusan pemilik atas paket **B1–B6** 21 Sep 2026); ubah ke `siap-pakai` saat sistem siap dipakai (cek W-01/W-02/W-03 kembali ketat; lihat `03_KONTRAK_WARISAN.md` bagian "Tahap pembangunan")
- **Status:** `Draft`
...
- [ ] Semua dokumen wajib tersedia — **belum: 6 dokumen masih kerangka + 5 terisi (01 — G0 LULUS; 02 — G1 LULUS, jenis acara pernikahan; 03 + 04 — **b1 LULUS**, PR #90 MERGED `de9bd12`; 05 — draft roadmap b2 (Discovery 05), keputusan pemilik paket B1–B6, menunggu review isi PR)**
