...
Folder ini **kosong di Sistem Building Aplikasi** — karena Building Aplikasi adalah **sistem untuk MEMBANGUN aplikasi**, bukan aplikasinya sendiri.
...
Template starter untuk keenamnya ada di `../_sistem/templates/` (copy-paste saat mulai, atau biarkan agent generate sesuai AGENT_SYSTEM.md).
