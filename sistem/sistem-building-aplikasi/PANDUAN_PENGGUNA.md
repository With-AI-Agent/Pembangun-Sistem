...
|---|---|---|
| 2026-09-16 | Run klinik ke-2 (rawat inap, kit v0.2.0): penegasan "SELURUH folder yang di-copy, bukan hanya `AGENT_SYSTEM.md`" + koreksi angka basi (8.1M→26M, 45K→46K, 7→10 template, 797→787 skill valid) + `_Notes.md` masuk daftar jangan-copy | Pemilik menemukan `PANDUAN_PEMAKAIAN.md` (v3, arsip) yang menyebut hanya `AGENT_SYSTEM.md` masuk repo baru → dua pedoman aktif saling bertentangan (cacat K-1, butir katalog baru C-07); angka-angka tertinggal sejak reinstall npx 26M/56 dirs |
