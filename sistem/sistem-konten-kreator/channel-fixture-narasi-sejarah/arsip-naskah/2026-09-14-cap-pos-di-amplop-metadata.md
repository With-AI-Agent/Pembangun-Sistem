...
- Segmen 03 (tidak diregenerasi): lingkaran cap buram di flap belakang amplop memuat fragmen/pseudo-glyph samar yang tersebar di dalam bingkai (goresan-goresan hitam yang tampak seperti potongan huruf/angka tetapi TIDAK membentuk kata/kalimat/kota/tanggal yang dapat dibaca). Ini dicatat jujur sebagai **accepted limitation** (batas kemampuan model; fragmen tidak bermakna dan tidak mengganggu narasi; serupa dengan status segmen 01 sebelum regenerasi). Tidak di-retry karena lingkaran cap segmen 03 tidak menjadi fokus utama bingkai dan fragmen tidak membentuk pesan terbaca.
- Segmen 06 (regenerasi, 2x retry): ponsel slab hitam polos generik, layar kosong hitam total, tanpa notch/camera cutout/home button/logo. Tepi ponsel terlihat tipis sebagai bezel hitam (tidak dapat dihindari pada benda rectangular); tidak ada tombol/ikon/teks di permukaan depan. Amplop cokelat tertutup rapi di samping. **Tidak ada accepted limitation** untuk teks/glyph; bezel tepi adalah bentuk fisik benda rectangular, bukan logo/teks.
